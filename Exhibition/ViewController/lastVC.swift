...
class lastVC: UIViewController {
    ...
    @objc private func handleRefreshcurentFair() {
        API_home.lastfairs{ (error: Error?, currentFairs: [currentFaire]?) in
...
extension lastVC: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
