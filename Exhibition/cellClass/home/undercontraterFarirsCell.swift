//
//  undercontraterFarirsCell.swift
//  Exhibition
//
...
class undercontraterFarirsCell: UICollectionViewCell {
    ...
    @IBOutlet weak var iame: UIImageView!
    @IBOutlet weak var title: UILabel!
    
    func configuerCell(item: underconstructionFair) {
        ...
        iame.kf.indicatorType = .activity
        if let url = URL(string: "\(encodedURL)") {
            print("g\(url)")
            iame.kf.setImage(with: url)
